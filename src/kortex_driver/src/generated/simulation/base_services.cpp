	...
	IBaseServices(node_handle)
{
	...
	m_serviceSetDeviceID = m_node_handle->create_service<kortex_driver::srv::SetDeviceID>("base/set_device_id", &BaseSimulationServices::SetDeviceID, this);
	m_serviceSetApiOptions = m_node_handle->create_service<kortex_driver::srv::SetApiOptions>("base/set_api_options", &BaseSimulationServices::SetApiOptions, this);

	m_serviceCreateUserProfile = m_node_handle->create_service<kortex_driver::srv::CreateUserProfile>("base/create_user_profile", &BaseSimulationServices::CreateUserProfile, this);
	m_serviceUpdateUserProfile = m_node_handle->create_service<kortex_driver::srv::UpdateUserProfile>("base/update_user_profile", &BaseSimulationServices::UpdateUserProfile, this);
	m_serviceReadUserProfile = m_node_handle->create_service<kortex_driver::srv::ReadUserProfile>("base/read_user_profile", &BaseSimulationServices::ReadUserProfile, this);
	m_serviceDeleteUserProfile = m_node_handle->create_service<kortex_driver::srv::DeleteUserProfile>("base/delete_user_profile", &BaseSimulationServices::DeleteUserProfile, this);
	m_serviceReadAllUserProfiles = m_node_handle->create_service<kortex_driver::srv::ReadAllUserProfiles>("base/read_all_user_profiles", &BaseSimulationServices::ReadAllUserProfiles, this);
	m_serviceReadAllUsers = m_node_handle->create_service<kortex_driver::srv::ReadAllUsers>("base/read_all_users", &BaseSimulationServices::ReadAllUsers, this);
	m_serviceChangePassword = m_node_handle->create_service<kortex_driver::srv::ChangePassword>("base/change_password", &BaseSimulationServices::ChangePassword, this);
	m_serviceCreateSequence = m_node_handle->create_service<kortex_driver::srv::CreateSequence>("base/create_sequence", &BaseSimulationServices::CreateSequence, this);
	m_serviceUpdateSequence = m_node_handle->create_service<kortex_driver::srv::UpdateSequence>("base/update_sequence", &BaseSimulationServices::UpdateSequence, this);
	m_serviceReadSequence = m_node_handle->create_service<kortex_driver::srv::ReadSequence>("base/read_sequence", &BaseSimulationServices::ReadSequence, this);
	m_serviceDeleteSequence = m_node_handle->create_service<kortex_driver::srv::DeleteSequence>("base/delete_sequence", &BaseSimulationServices::DeleteSequence, this);
	m_serviceReadAllSequences = m_node_handle->create_service<kortex_driver::srv::ReadAllSequences>("base/read_all_sequences", &BaseSimulationServices::ReadAllSequences, this);
	m_servicePlaySequence = m_node_handle->create_service<kortex_driver::srv::PlaySequence>("base/play_sequence", &BaseSimulationServices::PlaySequence, this);
	m_servicePlayAdvancedSequence = m_node_handle->create_service<kortex_driver::srv::PlayAdvancedSequence>("base/play_advanced_sequence", &BaseSimulationServices::PlayAdvancedSequence, this);
	m_serviceStopSequence = m_node_handle->create_service<kortex_driver::srv::StopSequence>("base/stop_sequence", &BaseSimulationServices::StopSequence, this);
	m_servicePauseSequence = m_node_handle->create_service<kortex_driver::srv::PauseSequence>("base/pause_sequence", &BaseSimulationServices::PauseSequence, this);
	m_serviceResumeSequence = m_node_handle->create_service<kortex_driver::srv::ResumeSequence>("base/resume_sequence", &BaseSimulationServices::ResumeSequence, this);
	m_serviceCreateProtectionZone = m_node_handle->create_service<kortex_driver::srv::CreateProtectionZone>("base/create_protection_zone", &BaseSimulationServices::CreateProtectionZone, this);
	m_serviceUpdateProtectionZone = m_node_handle->create_service<kortex_driver::srv::UpdateProtectionZone>("base/update_protection_zone", &BaseSimulationServices::UpdateProtectionZone, this);
	m_serviceReadProtectionZone = m_node_handle->create_service<kortex_driver::srv::ReadProtectionZone>("base/read_protection_zone", &BaseSimulationServices::ReadProtectionZone, this);
	m_serviceDeleteProtectionZone = m_node_handle->create_service<kortex_driver::srv::DeleteProtectionZone>("base/delete_protection_zone", &BaseSimulationServices::DeleteProtectionZone, this);
	m_serviceReadAllProtectionZones = m_node_handle->create_service<kortex_driver::srv::ReadAllProtectionZones>("base/read_all_protection_zones", &BaseSimulationServices::ReadAllProtectionZones, this);
	m_serviceCreateMapping = m_node_handle->create_service<kortex_driver::srv::CreateMapping>("base/create_mapping", &BaseSimulationServices::CreateMapping, this);
	m_serviceReadMapping = m_node_handle->create_service<kortex_driver::srv::ReadMapping>("base/read_mapping", &BaseSimulationServices::ReadMapping, this);
	m_serviceUpdateMapping = m_node_handle->create_service<kortex_driver::srv::UpdateMapping>("base/update_mapping", &BaseSimulationServices::UpdateMapping, this);
	m_serviceDeleteMapping = m_node_handle->create_service<kortex_driver::srv::DeleteMapping>("base/delete_mapping", &BaseSimulationServices::DeleteMapping, this);
	m_serviceReadAllMappings = m_node_handle->create_service<kortex_driver::srv::ReadAllMappings>("base/read_all_mappings", &BaseSimulationServices::ReadAllMappings, this);
	m_serviceCreateMap = m_node_handle->create_service<kortex_driver::srv::CreateMap>("base/create_map", &BaseSimulationServices::CreateMap, this);
	m_serviceReadMap = m_node_handle->create_service<kortex_driver::srv::ReadMap>("base/read_map", &BaseSimulationServices::ReadMap, this);
	m_serviceUpdateMap = m_node_handle->create_service<kortex_driver::srv::UpdateMap>("base/update_map", &BaseSimulationServices::UpdateMap, this);
	m_serviceDeleteMap = m_node_handle->create_service<kortex_driver::srv::DeleteMap>("base/delete_map", &BaseSimulationServices::DeleteMap, this);
	m_serviceReadAllMaps = m_node_handle->create_service<kortex_driver::srv::ReadAllMaps>("base/read_all_maps", &BaseSimulationServices::ReadAllMaps, this);
	m_serviceActivateMap = m_node_handle->create_service<kortex_driver::srv::ActivateMap>("base/activate_map", &BaseSimulationServices::ActivateMap, this);
	m_serviceCreateAction = m_node_handle->create_service<kortex_driver::srv::CreateAction>("base/create_action", &BaseSimulationServices::CreateAction, this);
	m_serviceReadAction = m_node_handle->create_service<kortex_driver::srv::ReadAction>("base/read_action", &BaseSimulationServices::ReadAction, this);
	m_serviceReadAllActions = m_node_handle->create_service<kortex_driver::srv::ReadAllActions>("base/read_all_actions", &BaseSimulationServices::ReadAllActions, this);
	m_serviceDeleteAction = m_node_handle->create_service<kortex_driver::srv::DeleteAction>("base/delete_action", &BaseSimulationServices::DeleteAction, this);
	m_serviceUpdateAction = m_node_handle->create_service<kortex_driver::srv::UpdateAction>("base/update_action", &BaseSimulationServices::UpdateAction, this);
	m_serviceExecuteActionFromReference = m_node_handle->create_service<kortex_driver::srv::ExecuteActionFromReference>("base/execute_action_from_reference", &BaseSimulationServices::ExecuteActionFromReference, this);
	m_serviceExecuteAction = m_node_handle->create_service<kortex_driver::srv::ExecuteAction>("base/execute_action", &BaseSimulationServices::ExecuteAction, this);
	m_servicePauseAction = m_node_handle->create_service<kortex_driver::srv::PauseAction>("base/pause_action", &BaseSimulationServices::PauseAction, this);
	m_serviceStopAction = m_node_handle->create_service<kortex_driver::srv::StopAction>("base/stop_action", &BaseSimulationServices::StopAction, this);
	m_serviceResumeAction = m_node_handle->create_service<kortex_driver::srv::ResumeAction>("base/resume_action", &BaseSimulationServices::ResumeAction, this);
	m_serviceGetIPv4Configuration = m_node_handle->create_service<kortex_driver::srv::GetIPv4Configuration>("base/get_i_pv4_configuration", &BaseSimulationServices::GetIPv4Configuration, this);
	m_serviceSetIPv4Configuration = m_node_handle->create_service<kortex_driver::srv::SetIPv4Configuration>("base/set_i_pv4_configuration", &BaseSimulationServices::SetIPv4Configuration, this);
	m_serviceSetCommunicationInterfaceEnable = m_node_handle->create_service<kortex_driver::srv::SetCommunicationInterfaceEnable>("base/set_communication_interface_enable", &BaseSimulationServices::SetCommunicationInterfaceEnable, this);
	m_serviceIsCommunicationInterfaceEnable = m_node_handle->create_service<kortex_driver::srv::IsCommunicationInterfaceEnable>("base/is_communication_interface_enable", &BaseSimulationServices::IsCommunicationInterfaceEnable, this);
	m_serviceGetAvailableWifi = m_node_handle->create_service<kortex_driver::srv::GetAvailableWifi>("base/get_available_wifi", &BaseSimulationServices::GetAvailableWifi, this);
	m_serviceGetWifiInformation = m_node_handle->create_service<kortex_driver::srv::GetWifiInformation>("base/get_wifi_information", &BaseSimulationServices::GetWifiInformation, this);
	m_serviceAddWifiConfiguration = m_node_handle->create_service<kortex_driver::srv::AddWifiConfiguration>("base/add_wifi_configuration", &BaseSimulationServices::AddWifiConfiguration, this);
	m_serviceDeleteWifiConfiguration = m_node_handle->create_service<kortex_driver::srv::DeleteWifiConfiguration>("base/delete_wifi_configuration", &BaseSimulationServices::DeleteWifiConfiguration, this);
	m_serviceGetAllConfiguredWifis = m_node_handle->create_service<kortex_driver::srv::GetAllConfiguredWifis>("base/get_all_configured_wifis", &BaseSimulationServices::GetAllConfiguredWifis, this);
	m_serviceConnectWifi = m_node_handle->create_service<kortex_driver::srv::ConnectWifi>("base/connect_wifi", &BaseSimulationServices::ConnectWifi, this);
	m_serviceDisconnectWifi = m_node_handle->create_service<kortex_driver::srv::DisconnectWifi>("base/disconnect_wifi", &BaseSimulationServices::DisconnectWifi, this);
	m_serviceGetConnectedWifiInformation = m_node_handle->create_service<kortex_driver::srv::GetConnectedWifiInformation>("base/get_connected_wifi_information", &BaseSimulationServices::GetConnectedWifiInformation, this);
	m_serviceBase_Unsubscribe = m_node_handle->create_service<kortex_driver::srv::BaseUnsubscribe>("base/unsubscribe", &BaseSimulationServices::Base_Unsubscribe, this);
	m_serviceOnNotificationConfigurationChangeTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationConfigurationChangeTopic>("base/activate_publishing_of_configuration_change_topic", &BaseSimulationServices::OnNotificationConfigurationChangeTopic, this);
	m_serviceOnNotificationMappingInfoTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationMappingInfoTopic>("base/activate_publishing_of_mapping_info_topic", &BaseSimulationServices::OnNotificationMappingInfoTopic, this);
	m_serviceBase_OnNotificationControlModeTopic = m_node_handle->create_service<kortex_driver::srv::BaseOnNotificationControlModeTopic>("base/activate_publishing_of_control_mode_topic", &BaseSimulationServices::Base_OnNotificationControlModeTopic, this);
	m_serviceOnNotificationOperatingModeTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationOperatingModeTopic>("base/activate_publishing_of_operating_mode_topic", &BaseSimulationServices::OnNotificationOperatingModeTopic, this);
	m_serviceOnNotificationSequenceInfoTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationSequenceInfoTopic>("base/activate_publishing_of_sequence_info_topic", &BaseSimulationServices::OnNotificationSequenceInfoTopic, this);
	m_serviceOnNotificationProtectionZoneTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationProtectionZoneTopic>("base/activate_publishing_of_protection_zone_topic", &BaseSimulationServices::OnNotificationProtectionZoneTopic, this);
	m_serviceOnNotificationUserTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationUserTopic>("base/activate_publishing_of_user_topic", &BaseSimulationServices::OnNotificationUserTopic, this);
	m_serviceOnNotificationControllerTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationControllerTopic>("base/activate_publishing_of_controller_topic", &BaseSimulationServices::OnNotificationControllerTopic, this);
	m_serviceOnNotificationActionTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationActionTopic>("base/activate_publishing_of_action_topic", &BaseSimulationServices::OnNotificationActionTopic, this);
	m_serviceOnNotificationRobotEventTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationRobotEventTopic>("base/activate_publishing_of_robot_event_topic", &BaseSimulationServices::OnNotificationRobotEventTopic, this);
	m_servicePlayCartesianTrajectory = m_node_handle->create_service<kortex_driver::srv::PlayCartesianTrajectory>("base/play_cartesian_trajectory", &BaseSimulationServices::PlayCartesianTrajectory, this);
	m_servicePlayCartesianTrajectoryPosition = m_node_handle->create_service<kortex_driver::srv::PlayCartesianTrajectoryPosition>("base/play_cartesian_trajectory_position", &BaseSimulationServices::PlayCartesianTrajectoryPosition, this);
	m_servicePlayCartesianTrajectoryOrientation = m_node_handle->create_service<kortex_driver::srv::PlayCartesianTrajectoryOrientation>("base/play_cartesian_trajectory_orientation", &BaseSimulationServices::PlayCartesianTrajectoryOrientation, this);
	m_serviceStop = m_node_handle->create_service<kortex_driver::srv::Stop>("base/stop", &BaseSimulationServices::Stop, this);
	m_serviceGetMeasuredCartesianPose = m_node_handle->create_service<kortex_driver::srv::GetMeasuredCartesianPose>("base/get_measured_cartesian_pose", &BaseSimulationServices::GetMeasuredCartesianPose, this);
	m_serviceSendWrenchCommand = m_node_handle->create_service<kortex_driver::srv::SendWrenchCommand>("base/send_wrench_command", &BaseSimulationServices::SendWrenchCommand, this);
	m_serviceSendWrenchJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendWrenchJoystickCommand>("base/send_wrench_joystick_command", &BaseSimulationServices::SendWrenchJoystickCommand, this);
	m_serviceSendTwistJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendTwistJoystickCommand>("base/send_twist_joystick_command", &BaseSimulationServices::SendTwistJoystickCommand, this);
	m_serviceSendTwistCommand = m_node_handle->create_service<kortex_driver::srv::SendTwistCommand>("base/send_twist_command", &BaseSimulationServices::SendTwistCommand, this);
	m_servicePlayJointTrajectory = m_node_handle->create_service<kortex_driver::srv::PlayJointTrajectory>("base/play_joint_trajectory", &BaseSimulationServices::PlayJointTrajectory, this);
	m_servicePlaySelectedJointTrajectory = m_node_handle->create_service<kortex_driver::srv::PlaySelectedJointTrajectory>("base/play_selected_joint_trajectory", &BaseSimulationServices::PlaySelectedJointTrajectory, this);
	m_serviceGetMeasuredJointAngles = m_node_handle->create_service<kortex_driver::srv::GetMeasuredJointAngles>("base/get_measured_joint_angles", &BaseSimulationServices::GetMeasuredJointAngles, this);
	m_serviceSendJointSpeedsCommand = m_node_handle->create_service<kortex_driver::srv::SendJointSpeedsCommand>("base/send_joint_speeds_command", &BaseSimulationServices::SendJointSpeedsCommand, this);
	m_serviceSendSelectedJointSpeedCommand = m_node_handle->create_service<kortex_driver::srv::SendSelectedJointSpeedCommand>("base/send_selected_joint_speed_command", &BaseSimulationServices::SendSelectedJointSpeedCommand, this);
	m_serviceSendGripperCommand = m_node_handle->create_service<kortex_driver::srv::SendGripperCommand>("base/send_gripper_command", &BaseSimulationServices::SendGripperCommand, this);
	m_serviceGetMeasuredGripperMovement = m_node_handle->create_service<kortex_driver::srv::GetMeasuredGripperMovement>("base/get_measured_gripper_movement", &BaseSimulationServices::GetMeasuredGripperMovement, this);
	m_serviceSetAdmittance = m_node_handle->create_service<kortex_driver::srv::SetAdmittance>("base/set_admittance", &BaseSimulationServices::SetAdmittance, this);
	m_serviceSetOperatingMode = m_node_handle->create_service<kortex_driver::srv::SetOperatingMode>("base/set_operating_mode", &BaseSimulationServices::SetOperatingMode, this);
	m_serviceApplyEmergencyStop = m_node_handle->create_service<kortex_driver::srv::ApplyEmergencyStop>("base/apply_emergency_stop", &BaseSimulationServices::ApplyEmergencyStop, this);
	m_serviceBase_ClearFaults = m_node_handle->create_service<kortex_driver::srv::BaseClearFaults>("base/clear_faults", &BaseSimulationServices::Base_ClearFaults, this);
	m_serviceBase_GetControlMode = m_node_handle->create_service<kortex_driver::srv::BaseGetControlMode>("base/get_control_mode", &BaseSimulationServices::Base_GetControlMode, this);
	m_serviceGetOperatingMode = m_node_handle->create_service<kortex_driver::srv::GetOperatingMode>("base/get_operating_mode", &BaseSimulationServices::GetOperatingMode, this);
	m_serviceSetServoingMode = m_node_handle->create_service<kortex_driver::srv::SetServoingMode>("base/set_servoing_mode", &BaseSimulationServices::SetServoingMode, this);
	m_serviceGetServoingMode = m_node_handle->create_service<kortex_driver::srv::GetServoingMode>("base/get_servoing_mode", &BaseSimulationServices::GetServoingMode, this);
	m_serviceOnNotificationServoingModeTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationServoingModeTopic>("base/activate_publishing_of_servoing_mode_topic", &BaseSimulationServices::OnNotificationServoingModeTopic, this);
	m_serviceRestoreFactorySettings = m_node_handle->create_service<kortex_driver::srv::RestoreFactorySettings>("base/restore_factory_settings", &BaseSimulationServices::RestoreFactorySettings, this);
	m_serviceOnNotificationFactoryTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationFactoryTopic>("base/activate_publishing_of_factory_topic", &BaseSimulationServices::OnNotificationFactoryTopic, this);
	m_serviceGetAllConnectedControllers = m_node_handle->create_service<kortex_driver::srv::GetAllConnectedControllers>("base/get_all_connected_controllers", &BaseSimulationServices::GetAllConnectedControllers, this);
	m_serviceGetControllerState = m_node_handle->create_service<kortex_driver::srv::GetControllerState>("base/get_controller_state", &BaseSimulationServices::GetControllerState, this);
	m_serviceGetActuatorCount = m_node_handle->create_service<kortex_driver::srv::GetActuatorCount>("base/get_actuator_count", &BaseSimulationServices::GetActuatorCount, this);
	m_serviceStartWifiScan = m_node_handle->create_service<kortex_driver::srv::StartWifiScan>("base/start_wifi_scan", &BaseSimulationServices::StartWifiScan, this);
	m_serviceGetConfiguredWifi = m_node_handle->create_service<kortex_driver::srv::GetConfiguredWifi>("base/get_configured_wifi", &BaseSimulationServices::GetConfiguredWifi, this);
	m_serviceOnNotificationNetworkTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationNetworkTopic>("base/activate_publishing_of_network_topic", &BaseSimulationServices::OnNotificationNetworkTopic, this);
	m_serviceGetArmState = m_node_handle->create_service<kortex_driver::srv::GetArmState>("base/get_arm_state", &BaseSimulationServices::GetArmState, this);
	m_serviceOnNotificationArmStateTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationArmStateTopic>("base/activate_publishing_of_arm_state_topic", &BaseSimulationServices::OnNotificationArmStateTopic, this);
	m_serviceGetIPv4Information = m_node_handle->create_service<kortex_driver::srv::GetIPv4Information>("base/get_i_pv4_information", &BaseSimulationServices::GetIPv4Information, this);
	m_serviceSetWifiCountryCode = m_node_handle->create_service<kortex_driver::srv::SetWifiCountryCode>("base/set_wifi_country_code", &BaseSimulationServices::SetWifiCountryCode, this);
	m_serviceGetWifiCountryCode = m_node_handle->create_service<kortex_driver::srv::GetWifiCountryCode>("base/get_wifi_country_code", &BaseSimulationServices::GetWifiCountryCode, this);
	m_serviceBase_SetCapSenseConfig = m_node_handle->create_service<kortex_driver::srv::BaseSetCapSenseConfig>("base/set_cap_sense_config", &BaseSimulationServices::Base_SetCapSenseConfig, this);
	m_serviceBase_GetCapSenseConfig = m_node_handle->create_service<kortex_driver::srv::BaseGetCapSenseConfig>("base/get_cap_sense_config", &BaseSimulationServices::Base_GetCapSenseConfig, this);
	m_serviceGetAllJointsSpeedHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsSpeedHardLimitation>("base/get_all_joints_speed_hard_limitation", &BaseSimulationServices::GetAllJointsSpeedHardLimitation, this);
	m_serviceGetAllJointsTorqueHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsTorqueHardLimitation>("base/get_all_joints_torque_hard_limitation", &BaseSimulationServices::GetAllJointsTorqueHardLimitation, this);
	m_serviceGetTwistHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetTwistHardLimitation>("base/get_twist_hard_limitation", &BaseSimulationServices::GetTwistHardLimitation, this);
	m_serviceGetWrenchHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetWrenchHardLimitation>("base/get_wrench_hard_limitation", &BaseSimulationServices::GetWrenchHardLimitation, this);
	m_serviceSendJointSpeedsJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendJointSpeedsJoystickCommand>("base/send_joint_speeds_joystick_command", &BaseSimulationServices::SendJointSpeedsJoystickCommand, this);
	m_serviceSendSelectedJointSpeedJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendSelectedJointSpeedJoystickCommand>("base/send_selected_joint_speed_joystick_command", &BaseSimulationServices::SendSelectedJointSpeedJoystickCommand, this);
	m_serviceEnableBridge = m_node_handle->create_service<kortex_driver::srv::EnableBridge>("base/enable_bridge", &BaseSimulationServices::EnableBridge, this);
	m_serviceDisableBridge = m_node_handle->create_service<kortex_driver::srv::DisableBridge>("base/disable_bridge", &BaseSimulationServices::DisableBridge, this);
	m_serviceGetBridgeList = m_node_handle->create_service<kortex_driver::srv::GetBridgeList>("base/get_bridge_list", &BaseSimulationServices::GetBridgeList, this);
	m_serviceGetBridgeConfig = m_node_handle->create_service<kortex_driver::srv::GetBridgeConfig>("base/get_bridge_config", &BaseSimulationServices::GetBridgeConfig, this);
	m_servicePlayPreComputedJointTrajectory = m_node_handle->create_service<kortex_driver::srv::PlayPreComputedJointTrajectory>("base/play_pre_computed_joint_trajectory", &BaseSimulationServices::PlayPreComputedJointTrajectory, this);
	m_serviceGetProductConfiguration = m_node_handle->create_service<kortex_driver::srv::GetProductConfiguration>("base/get_product_configuration", &BaseSimulationServices::GetProductConfiguration, this);
	m_serviceUpdateEndEffectorTypeConfiguration = m_node_handle->create_service<kortex_driver::srv::UpdateEndEffectorTypeConfiguration>("base/update_end_effector_type_configuration", &BaseSimulationServices::UpdateEndEffectorTypeConfiguration, this);
	m_serviceRestoreFactoryProductConfiguration = m_node_handle->create_service<kortex_driver::srv::RestoreFactoryProductConfiguration>("base/restore_factory_product_configuration", &BaseSimulationServices::RestoreFactoryProductConfiguration, this);
	m_serviceGetTrajectoryErrorReport = m_node_handle->create_service<kortex_driver::srv::GetTrajectoryErrorReport>("base/get_trajectory_error_report", &BaseSimulationServices::GetTrajectoryErrorReport, this);
	m_serviceGetAllJointsSpeedSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsSpeedSoftLimitation>("base/get_all_joints_speed_soft_limitation", &BaseSimulationServices::GetAllJointsSpeedSoftLimitation, this);
	m_serviceGetAllJointsTorqueSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsTorqueSoftLimitation>("base/get_all_joints_torque_soft_limitation", &BaseSimulationServices::GetAllJointsTorqueSoftLimitation, this);
	m_serviceGetTwistSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetTwistSoftLimitation>("base/get_twist_soft_limitation", &BaseSimulationServices::GetTwistSoftLimitation, this);
	m_serviceGetWrenchSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetWrenchSoftLimitation>("base/get_wrench_soft_limitation", &BaseSimulationServices::GetWrenchSoftLimitation, this);
	m_serviceSetControllerConfigurationMode = m_node_handle->create_service<kortex_driver::srv::SetControllerConfigurationMode>("base/set_controller_configuration_mode", &BaseSimulationServices::SetControllerConfigurationMode, this);
	m_serviceGetControllerConfigurationMode = m_node_handle->create_service<kortex_driver::srv::GetControllerConfigurationMode>("base/get_controller_configuration_mode", &BaseSimulationServices::GetControllerConfigurationMode, this);
	m_serviceStartTeaching = m_node_handle->create_service<kortex_driver::srv::StartTeaching>("base/start_teaching", &BaseSimulationServices::StartTeaching, this);
	m_serviceStopTeaching = m_node_handle->create_service<kortex_driver::srv::StopTeaching>("base/stop_teaching", &BaseSimulationServices::StopTeaching, this);
	m_serviceAddSequenceTasks = m_node_handle->create_service<kortex_driver::srv::AddSequenceTasks>("base/add_sequence_tasks", &BaseSimulationServices::AddSequenceTasks, this);
	m_serviceUpdateSequenceTask = m_node_handle->create_service<kortex_driver::srv::UpdateSequenceTask>("base/update_sequence_task", &BaseSimulationServices::UpdateSequenceTask, this);
	m_serviceSwapSequenceTasks = m_node_handle->create_service<kortex_driver::srv::SwapSequenceTasks>("base/swap_sequence_tasks", &BaseSimulationServices::SwapSequenceTasks, this);
	m_serviceReadSequenceTask = m_node_handle->create_service<kortex_driver::srv::ReadSequenceTask>("base/read_sequence_task", &BaseSimulationServices::ReadSequenceTask, this);
	m_serviceReadAllSequenceTasks = m_node_handle->create_service<kortex_driver::srv::ReadAllSequenceTasks>("base/read_all_sequence_tasks", &BaseSimulationServices::ReadAllSequenceTasks, this);
	m_serviceDeleteSequenceTask = m_node_handle->create_service<kortex_driver::srv::DeleteSequenceTask>("base/delete_sequence_task", &BaseSimulationServices::DeleteSequenceTask, this);
	m_serviceDeleteAllSequenceTasks = m_node_handle->create_service<kortex_driver::srv::DeleteAllSequenceTasks>("base/delete_all_sequence_tasks", &BaseSimulationServices::DeleteAllSequenceTasks, this);
	m_serviceTakeSnapshot = m_node_handle->create_service<kortex_driver::srv::TakeSnapshot>("base/take_snapshot", &BaseSimulationServices::TakeSnapshot, this);
	m_serviceGetFirmwareBundleVersions = m_node_handle->create_service<kortex_driver::srv::GetFirmwareBundleVersions>("base/get_firmware_bundle_versions", &BaseSimulationServices::GetFirmwareBundleVersions, this);
	m_serviceExecuteWaypointTrajectory = m_node_handle->create_service<kortex_driver::srv::ExecuteWaypointTrajectory>("base/execute_waypoint_trajectory", &BaseSimulationServices::ExecuteWaypointTrajectory, this);
	m_serviceMoveSequenceTask = m_node_handle->create_service<kortex_driver::srv::MoveSequenceTask>("base/move_sequence_task", &BaseSimulationServices::MoveSequenceTask, this);
	m_serviceDuplicateMapping = m_node_handle->create_service<kortex_driver::srv::DuplicateMapping>("base/duplicate_mapping", &BaseSimulationServices::DuplicateMapping, this);
	m_serviceDuplicateMap = m_node_handle->create_service<kortex_driver::srv::DuplicateMap>("base/duplicate_map", &BaseSimulationServices::DuplicateMap, this);
	m_serviceSetControllerConfiguration = m_node_handle->create_service<kortex_driver::srv::SetControllerConfiguration>("base/set_controller_configuration", &BaseSimulationServices::SetControllerConfiguration, this);
	m_serviceGetControllerConfiguration = m_node_handle->create_service<kortex_driver::srv::GetControllerConfiguration>("base/get_controller_configuration", &BaseSimulationServices::GetControllerConfiguration, this);
	m_serviceGetAllControllerConfigurations = m_node_handle->create_service<kortex_driver::srv::GetAllControllerConfigurations>("base/get_all_controller_configurations", &BaseSimulationServices::GetAllControllerConfigurations, this);
	m_serviceComputeForwardKinematics = m_node_handle->create_service<kortex_driver::srv::ComputeForwardKinematics>("base/compute_forward_kinematics", &BaseSimulationServices::ComputeForwardKinematics, this);
	m_serviceComputeInverseKinematics = m_node_handle->create_service<kortex_driver::srv::ComputeInverseKinematics>("base/compute_inverse_kinematics", &BaseSimulationServices::ComputeInverseKinematics, this);
	m_serviceValidateWaypointList = m_node_handle->create_service<kortex_driver::srv::ValidateWaypointList>("base/validate_waypoint_list", &BaseSimulationServices::ValidateWaypointList, this);
}
