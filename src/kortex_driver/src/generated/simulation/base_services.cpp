	...
	IBaseServices(node_handle)
{
	...
	m_serviceSetDeviceID = m_node_handle->create_service<kortex_driver::srv::SetDeviceID>("base/set_device_id", &BaseSimulationServices::SetDeviceID);
	m_serviceSetApiOptions = m_node_handle->create_service<kortex_driver::srv::SetApiOptions>("base/set_api_options", &BaseSimulationServices::SetApiOptions);

	m_serviceCreateUserProfile = m_node_handle->create_service<kortex_driver::srv::CreateUserProfile>("base/create_user_profile", &BaseSimulationServices::CreateUserProfile);
	m_serviceUpdateUserProfile = m_node_handle->create_service<kortex_driver::srv::UpdateUserProfile>("base/update_user_profile", &BaseSimulationServices::UpdateUserProfile);
	m_serviceReadUserProfile = m_node_handle->create_service<kortex_driver::srv::ReadUserProfile>("base/read_user_profile", &BaseSimulationServices::ReadUserProfile);
	m_serviceDeleteUserProfile = m_node_handle->create_service<kortex_driver::srv::DeleteUserProfile>("base/delete_user_profile", &BaseSimulationServices::DeleteUserProfile);
	m_serviceReadAllUserProfiles = m_node_handle->create_service<kortex_driver::srv::ReadAllUserProfiles>("base/read_all_user_profiles", &BaseSimulationServices::ReadAllUserProfiles);
	m_serviceReadAllUsers = m_node_handle->create_service<kortex_driver::srv::ReadAllUsers>("base/read_all_users", &BaseSimulationServices::ReadAllUsers);
	m_serviceChangePassword = m_node_handle->create_service<kortex_driver::srv::ChangePassword>("base/change_password", &BaseSimulationServices::ChangePassword);
	m_serviceCreateSequence = m_node_handle->create_service<kortex_driver::srv::CreateSequence>("base/create_sequence", &BaseSimulationServices::CreateSequence);
	m_serviceUpdateSequence = m_node_handle->create_service<kortex_driver::srv::UpdateSequence>("base/update_sequence", &BaseSimulationServices::UpdateSequence);
	m_serviceReadSequence = m_node_handle->create_service<kortex_driver::srv::ReadSequence>("base/read_sequence", &BaseSimulationServices::ReadSequence);
	m_serviceDeleteSequence = m_node_handle->create_service<kortex_driver::srv::DeleteSequence>("base/delete_sequence", &BaseSimulationServices::DeleteSequence);
	m_serviceReadAllSequences = m_node_handle->create_service<kortex_driver::srv::ReadAllSequences>("base/read_all_sequences", &BaseSimulationServices::ReadAllSequences);
	m_servicePlaySequence = m_node_handle->create_service<kortex_driver::srv::PlaySequence>("base/play_sequence", &BaseSimulationServices::PlaySequence);
	m_servicePlayAdvancedSequence = m_node_handle->create_service<kortex_driver::srv::PlayAdvancedSequence>("base/play_advanced_sequence", &BaseSimulationServices::PlayAdvancedSequence);
	m_serviceStopSequence = m_node_handle->create_service<kortex_driver::srv::StopSequence>("base/stop_sequence", &BaseSimulationServices::StopSequence);
	m_servicePauseSequence = m_node_handle->create_service<kortex_driver::srv::PauseSequence>("base/pause_sequence", &BaseSimulationServices::PauseSequence);
	m_serviceResumeSequence = m_node_handle->create_service<kortex_driver::srv::ResumeSequence>("base/resume_sequence", &BaseSimulationServices::ResumeSequence);
	m_serviceCreateProtectionZone = m_node_handle->create_service<kortex_driver::srv::CreateProtectionZone>("base/create_protection_zone", &BaseSimulationServices::CreateProtectionZone);
	m_serviceUpdateProtectionZone = m_node_handle->create_service<kortex_driver::srv::UpdateProtectionZone>("base/update_protection_zone", &BaseSimulationServices::UpdateProtectionZone);
	m_serviceReadProtectionZone = m_node_handle->create_service<kortex_driver::srv::ReadProtectionZone>("base/read_protection_zone", &BaseSimulationServices::ReadProtectionZone);
	m_serviceDeleteProtectionZone = m_node_handle->create_service<kortex_driver::srv::DeleteProtectionZone>("base/delete_protection_zone", &BaseSimulationServices::DeleteProtectionZone);
	m_serviceReadAllProtectionZones = m_node_handle->create_service<kortex_driver::srv::ReadAllProtectionZones>("base/read_all_protection_zones", &BaseSimulationServices::ReadAllProtectionZones);
	m_serviceCreateMapping = m_node_handle->create_service<kortex_driver::srv::CreateMapping>("base/create_mapping", &BaseSimulationServices::CreateMapping);
	m_serviceReadMapping = m_node_handle->create_service<kortex_driver::srv::ReadMapping>("base/read_mapping", &BaseSimulationServices::ReadMapping);
	m_serviceUpdateMapping = m_node_handle->create_service<kortex_driver::srv::UpdateMapping>("base/update_mapping", &BaseSimulationServices::UpdateMapping);
	m_serviceDeleteMapping = m_node_handle->create_service<kortex_driver::srv::DeleteMapping>("base/delete_mapping", &BaseSimulationServices::DeleteMapping);
	m_serviceReadAllMappings = m_node_handle->create_service<kortex_driver::srv::ReadAllMappings>("base/read_all_mappings", &BaseSimulationServices::ReadAllMappings);
	m_serviceCreateMap = m_node_handle->create_service<kortex_driver::srv::CreateMap>("base/create_map", &BaseSimulationServices::CreateMap);
	m_serviceReadMap = m_node_handle->create_service<kortex_driver::srv::ReadMap>("base/read_map", &BaseSimulationServices::ReadMap);
	m_serviceUpdateMap = m_node_handle->create_service<kortex_driver::srv::UpdateMap>("base/update_map", &BaseSimulationServices::UpdateMap);
	m_serviceDeleteMap = m_node_handle->create_service<kortex_driver::srv::DeleteMap>("base/delete_map", &BaseSimulationServices::DeleteMap);
	m_serviceReadAllMaps = m_node_handle->create_service<kortex_driver::srv::ReadAllMaps>("base/read_all_maps", &BaseSimulationServices::ReadAllMaps);
	m_serviceActivateMap = m_node_handle->create_service<kortex_driver::srv::ActivateMap>("base/activate_map", &BaseSimulationServices::ActivateMap);
	m_serviceCreateAction = m_node_handle->create_service<kortex_driver::srv::CreateAction>("base/create_action", &BaseSimulationServices::CreateAction);
	m_serviceReadAction = m_node_handle->create_service<kortex_driver::srv::ReadAction>("base/read_action", &BaseSimulationServices::ReadAction);
	m_serviceReadAllActions = m_node_handle->create_service<kortex_driver::srv::ReadAllActions>("base/read_all_actions", &BaseSimulationServices::ReadAllActions);
	m_serviceDeleteAction = m_node_handle->create_service<kortex_driver::srv::DeleteAction>("base/delete_action", &BaseSimulationServices::DeleteAction);
	m_serviceUpdateAction = m_node_handle->create_service<kortex_driver::srv::UpdateAction>("base/update_action", &BaseSimulationServices::UpdateAction);
	m_serviceExecuteActionFromReference = m_node_handle->create_service<kortex_driver::srv::ExecuteActionFromReference>("base/execute_action_from_reference", &BaseSimulationServices::ExecuteActionFromReference);
	m_serviceExecuteAction = m_node_handle->create_service<kortex_driver::srv::ExecuteAction>("base/execute_action", &BaseSimulationServices::ExecuteAction);
	m_servicePauseAction = m_node_handle->create_service<kortex_driver::srv::PauseAction>("base/pause_action", &BaseSimulationServices::PauseAction);
	m_serviceStopAction = m_node_handle->create_service<kortex_driver::srv::StopAction>("base/stop_action", &BaseSimulationServices::StopAction);
	m_serviceResumeAction = m_node_handle->create_service<kortex_driver::srv::ResumeAction>("base/resume_action", &BaseSimulationServices::ResumeAction);
	m_serviceGetIPv4Configuration = m_node_handle->create_service<kortex_driver::srv::GetIPv4Configuration>("base/get_i_pv4_configuration", &BaseSimulationServices::GetIPv4Configuration);
	m_serviceSetIPv4Configuration = m_node_handle->create_service<kortex_driver::srv::SetIPv4Configuration>("base/set_i_pv4_configuration", &BaseSimulationServices::SetIPv4Configuration);
	m_serviceSetCommunicationInterfaceEnable = m_node_handle->create_service<kortex_driver::srv::SetCommunicationInterfaceEnable>("base/set_communication_interface_enable", &BaseSimulationServices::SetCommunicationInterfaceEnable);
	m_serviceIsCommunicationInterfaceEnable = m_node_handle->create_service<kortex_driver::srv::IsCommunicationInterfaceEnable>("base/is_communication_interface_enable", &BaseSimulationServices::IsCommunicationInterfaceEnable);
	m_serviceGetAvailableWifi = m_node_handle->create_service<kortex_driver::srv::GetAvailableWifi>("base/get_available_wifi", &BaseSimulationServices::GetAvailableWifi);
	m_serviceGetWifiInformation = m_node_handle->create_service<kortex_driver::srv::GetWifiInformation>("base/get_wifi_information", &BaseSimulationServices::GetWifiInformation);
	m_serviceAddWifiConfiguration = m_node_handle->create_service<kortex_driver::srv::AddWifiConfiguration>("base/add_wifi_configuration", &BaseSimulationServices::AddWifiConfiguration);
	m_serviceDeleteWifiConfiguration = m_node_handle->create_service<kortex_driver::srv::DeleteWifiConfiguration>("base/delete_wifi_configuration", &BaseSimulationServices::DeleteWifiConfiguration);
	m_serviceGetAllConfiguredWifis = m_node_handle->create_service<kortex_driver::srv::GetAllConfiguredWifis>("base/get_all_configured_wifis", &BaseSimulationServices::GetAllConfiguredWifis);
	m_serviceConnectWifi = m_node_handle->create_service<kortex_driver::srv::ConnectWifi>("base/connect_wifi", &BaseSimulationServices::ConnectWifi);
	m_serviceDisconnectWifi = m_node_handle->create_service<kortex_driver::srv::DisconnectWifi>("base/disconnect_wifi", &BaseSimulationServices::DisconnectWifi);
	m_serviceGetConnectedWifiInformation = m_node_handle->create_service<kortex_driver::srv::GetConnectedWifiInformation>("base/get_connected_wifi_information", &BaseSimulationServices::GetConnectedWifiInformation);
	m_serviceBase_Unsubscribe = m_node_handle->create_service<kortex_driver::srv::BaseUnsubscribe>("base/unsubscribe", &BaseSimulationServices::Base_Unsubscribe);
	m_serviceOnNotificationConfigurationChangeTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationConfigurationChangeTopic>("base/activate_publishing_of_configuration_change_topic", &BaseSimulationServices::OnNotificationConfigurationChangeTopic);
	m_serviceOnNotificationMappingInfoTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationMappingInfoTopic>("base/activate_publishing_of_mapping_info_topic", &BaseSimulationServices::OnNotificationMappingInfoTopic);
	m_serviceBase_OnNotificationControlModeTopic = m_node_handle->create_service<kortex_driver::srv::BaseOnNotificationControlModeTopic>("base/activate_publishing_of_control_mode_topic", &BaseSimulationServices::Base_OnNotificationControlModeTopic);
	m_serviceOnNotificationOperatingModeTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationOperatingModeTopic>("base/activate_publishing_of_operating_mode_topic", &BaseSimulationServices::OnNotificationOperatingModeTopic);
	m_serviceOnNotificationSequenceInfoTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationSequenceInfoTopic>("base/activate_publishing_of_sequence_info_topic", &BaseSimulationServices::OnNotificationSequenceInfoTopic);
	m_serviceOnNotificationProtectionZoneTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationProtectionZoneTopic>("base/activate_publishing_of_protection_zone_topic", &BaseSimulationServices::OnNotificationProtectionZoneTopic);
	m_serviceOnNotificationUserTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationUserTopic>("base/activate_publishing_of_user_topic", &BaseSimulationServices::OnNotificationUserTopic);
	m_serviceOnNotificationControllerTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationControllerTopic>("base/activate_publishing_of_controller_topic", &BaseSimulationServices::OnNotificationControllerTopic);
	m_serviceOnNotificationActionTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationActionTopic>("base/activate_publishing_of_action_topic", &BaseSimulationServices::OnNotificationActionTopic);
	m_serviceOnNotificationRobotEventTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationRobotEventTopic>("base/activate_publishing_of_robot_event_topic", &BaseSimulationServices::OnNotificationRobotEventTopic);
	m_servicePlayCartesianTrajectory = m_node_handle->create_service<kortex_driver::srv::PlayCartesianTrajectory>("base/play_cartesian_trajectory", &BaseSimulationServices::PlayCartesianTrajectory);
	m_servicePlayCartesianTrajectoryPosition = m_node_handle->create_service<kortex_driver::srv::PlayCartesianTrajectoryPosition>("base/play_cartesian_trajectory_position", &BaseSimulationServices::PlayCartesianTrajectoryPosition);
	m_servicePlayCartesianTrajectoryOrientation = m_node_handle->create_service<kortex_driver::srv::PlayCartesianTrajectoryOrientation>("base/play_cartesian_trajectory_orientation", &BaseSimulationServices::PlayCartesianTrajectoryOrientation);
	m_serviceStop = m_node_handle->create_service<kortex_driver::srv::Stop>("base/stop", &BaseSimulationServices::Stop);
	m_serviceGetMeasuredCartesianPose = m_node_handle->create_service<kortex_driver::srv::GetMeasuredCartesianPose>("base/get_measured_cartesian_pose", &BaseSimulationServices::GetMeasuredCartesianPose);
	m_serviceSendWrenchCommand = m_node_handle->create_service<kortex_driver::srv::SendWrenchCommand>("base/send_wrench_command", &BaseSimulationServices::SendWrenchCommand);
	m_serviceSendWrenchJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendWrenchJoystickCommand>("base/send_wrench_joystick_command", &BaseSimulationServices::SendWrenchJoystickCommand);
	m_serviceSendTwistJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendTwistJoystickCommand>("base/send_twist_joystick_command", &BaseSimulationServices::SendTwistJoystickCommand);
	m_serviceSendTwistCommand = m_node_handle->create_service<kortex_driver::srv::SendTwistCommand>("base/send_twist_command", &BaseSimulationServices::SendTwistCommand);
	m_servicePlayJointTrajectory = m_node_handle->create_service<kortex_driver::srv::PlayJointTrajectory>("base/play_joint_trajectory", &BaseSimulationServices::PlayJointTrajectory);
	m_servicePlaySelectedJointTrajectory = m_node_handle->create_service<kortex_driver::srv::PlaySelectedJointTrajectory>("base/play_selected_joint_trajectory", &BaseSimulationServices::PlaySelectedJointTrajectory);
	m_serviceGetMeasuredJointAngles = m_node_handle->create_service<kortex_driver::srv::GetMeasuredJointAngles>("base/get_measured_joint_angles", &BaseSimulationServices::GetMeasuredJointAngles);
	m_serviceSendJointSpeedsCommand = m_node_handle->create_service<kortex_driver::srv::SendJointSpeedsCommand>("base/send_joint_speeds_command", &BaseSimulationServices::SendJointSpeedsCommand);
	m_serviceSendSelectedJointSpeedCommand = m_node_handle->create_service<kortex_driver::srv::SendSelectedJointSpeedCommand>("base/send_selected_joint_speed_command", &BaseSimulationServices::SendSelectedJointSpeedCommand);
	m_serviceSendGripperCommand = m_node_handle->create_service<kortex_driver::srv::SendGripperCommand>("base/send_gripper_command", &BaseSimulationServices::SendGripperCommand);
	m_serviceGetMeasuredGripperMovement = m_node_handle->create_service<kortex_driver::srv::GetMeasuredGripperMovement>("base/get_measured_gripper_movement", &BaseSimulationServices::GetMeasuredGripperMovement);
	m_serviceSetAdmittance = m_node_handle->create_service<kortex_driver::srv::SetAdmittance>("base/set_admittance", &BaseSimulationServices::SetAdmittance);
	m_serviceSetOperatingMode = m_node_handle->create_service<kortex_driver::srv::SetOperatingMode>("base/set_operating_mode", &BaseSimulationServices::SetOperatingMode);
	m_serviceApplyEmergencyStop = m_node_handle->create_service<kortex_driver::srv::ApplyEmergencyStop>("base/apply_emergency_stop", &BaseSimulationServices::ApplyEmergencyStop);
	m_serviceBase_ClearFaults = m_node_handle->create_service<kortex_driver::srv::BaseClearFaults>("base/clear_faults", &BaseSimulationServices::Base_ClearFaults);
	m_serviceBase_GetControlMode = m_node_handle->create_service<kortex_driver::srv::BaseGetControlMode>("base/get_control_mode", &BaseSimulationServices::Base_GetControlMode);
	m_serviceGetOperatingMode = m_node_handle->create_service<kortex_driver::srv::GetOperatingMode>("base/get_operating_mode", &BaseSimulationServices::GetOperatingMode);
	m_serviceSetServoingMode = m_node_handle->create_service<kortex_driver::srv::SetServoingMode>("base/set_servoing_mode", &BaseSimulationServices::SetServoingMode);
	m_serviceGetServoingMode = m_node_handle->create_service<kortex_driver::srv::GetServoingMode>("base/get_servoing_mode", &BaseSimulationServices::GetServoingMode);
	m_serviceOnNotificationServoingModeTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationServoingModeTopic>("base/activate_publishing_of_servoing_mode_topic", &BaseSimulationServices::OnNotificationServoingModeTopic);
	m_serviceRestoreFactorySettings = m_node_handle->create_service<kortex_driver::srv::RestoreFactorySettings>("base/restore_factory_settings", &BaseSimulationServices::RestoreFactorySettings);
	m_serviceOnNotificationFactoryTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationFactoryTopic>("base/activate_publishing_of_factory_topic", &BaseSimulationServices::OnNotificationFactoryTopic);
	m_serviceGetAllConnectedControllers = m_node_handle->create_service<kortex_driver::srv::GetAllConnectedControllers>("base/get_all_connected_controllers", &BaseSimulationServices::GetAllConnectedControllers);
	m_serviceGetControllerState = m_node_handle->create_service<kortex_driver::srv::GetControllerState>("base/get_controller_state", &BaseSimulationServices::GetControllerState);
	m_serviceGetActuatorCount = m_node_handle->create_service<kortex_driver::srv::GetActuatorCount>("base/get_actuator_count", &BaseSimulationServices::GetActuatorCount);
	m_serviceStartWifiScan = m_node_handle->create_service<kortex_driver::srv::StartWifiScan>("base/start_wifi_scan", &BaseSimulationServices::StartWifiScan);
	m_serviceGetConfiguredWifi = m_node_handle->create_service<kortex_driver::srv::GetConfiguredWifi>("base/get_configured_wifi", &BaseSimulationServices::GetConfiguredWifi);
	m_serviceOnNotificationNetworkTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationNetworkTopic>("base/activate_publishing_of_network_topic", &BaseSimulationServices::OnNotificationNetworkTopic);
	m_serviceGetArmState = m_node_handle->create_service<kortex_driver::srv::GetArmState>("base/get_arm_state", &BaseSimulationServices::GetArmState);
	m_serviceOnNotificationArmStateTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationArmStateTopic>("base/activate_publishing_of_arm_state_topic", &BaseSimulationServices::OnNotificationArmStateTopic);
	m_serviceGetIPv4Information = m_node_handle->create_service<kortex_driver::srv::GetIPv4Information>("base/get_i_pv4_information", &BaseSimulationServices::GetIPv4Information);
	m_serviceSetWifiCountryCode = m_node_handle->create_service<kortex_driver::srv::SetWifiCountryCode>("base/set_wifi_country_code", &BaseSimulationServices::SetWifiCountryCode);
	m_serviceGetWifiCountryCode = m_node_handle->create_service<kortex_driver::srv::GetWifiCountryCode>("base/get_wifi_country_code", &BaseSimulationServices::GetWifiCountryCode);
	m_serviceBase_SetCapSenseConfig = m_node_handle->create_service<kortex_driver::srv::BaseSetCapSenseConfig>("base/set_cap_sense_config", &BaseSimulationServices::Base_SetCapSenseConfig);
	m_serviceBase_GetCapSenseConfig = m_node_handle->create_service<kortex_driver::srv::BaseGetCapSenseConfig>("base/get_cap_sense_config", &BaseSimulationServices::Base_GetCapSenseConfig);
	m_serviceGetAllJointsSpeedHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsSpeedHardLimitation>("base/get_all_joints_speed_hard_limitation", &BaseSimulationServices::GetAllJointsSpeedHardLimitation);
	m_serviceGetAllJointsTorqueHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsTorqueHardLimitation>("base/get_all_joints_torque_hard_limitation", &BaseSimulationServices::GetAllJointsTorqueHardLimitation);
	m_serviceGetTwistHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetTwistHardLimitation>("base/get_twist_hard_limitation", &BaseSimulationServices::GetTwistHardLimitation);
	m_serviceGetWrenchHardLimitation = m_node_handle->create_service<kortex_driver::srv::GetWrenchHardLimitation>("base/get_wrench_hard_limitation", &BaseSimulationServices::GetWrenchHardLimitation);
	m_serviceSendJointSpeedsJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendJointSpeedsJoystickCommand>("base/send_joint_speeds_joystick_command", &BaseSimulationServices::SendJointSpeedsJoystickCommand);
	m_serviceSendSelectedJointSpeedJoystickCommand = m_node_handle->create_service<kortex_driver::srv::SendSelectedJointSpeedJoystickCommand>("base/send_selected_joint_speed_joystick_command", &BaseSimulationServices::SendSelectedJointSpeedJoystickCommand);
	m_serviceEnableBridge = m_node_handle->create_service<kortex_driver::srv::EnableBridge>("base/enable_bridge", &BaseSimulationServices::EnableBridge);
	m_serviceDisableBridge = m_node_handle->create_service<kortex_driver::srv::DisableBridge>("base/disable_bridge", &BaseSimulationServices::DisableBridge);
	m_serviceGetBridgeList = m_node_handle->create_service<kortex_driver::srv::GetBridgeList>("base/get_bridge_list", &BaseSimulationServices::GetBridgeList);
	m_serviceGetBridgeConfig = m_node_handle->create_service<kortex_driver::srv::GetBridgeConfig>("base/get_bridge_config", &BaseSimulationServices::GetBridgeConfig);
	m_servicePlayPreComputedJointTrajectory = m_node_handle->create_service<kortex_driver::srv::PlayPreComputedJointTrajectory>("base/play_pre_computed_joint_trajectory", &BaseSimulationServices::PlayPreComputedJointTrajectory);
	m_serviceGetProductConfiguration = m_node_handle->create_service<kortex_driver::srv::GetProductConfiguration>("base/get_product_configuration", &BaseSimulationServices::GetProductConfiguration);
	m_serviceUpdateEndEffectorTypeConfiguration = m_node_handle->create_service<kortex_driver::srv::UpdateEndEffectorTypeConfiguration>("base/update_end_effector_type_configuration", &BaseSimulationServices::UpdateEndEffectorTypeConfiguration);
	m_serviceRestoreFactoryProductConfiguration = m_node_handle->create_service<kortex_driver::srv::RestoreFactoryProductConfiguration>("base/restore_factory_product_configuration", &BaseSimulationServices::RestoreFactoryProductConfiguration);
	m_serviceGetTrajectoryErrorReport = m_node_handle->create_service<kortex_driver::srv::GetTrajectoryErrorReport>("base/get_trajectory_error_report", &BaseSimulationServices::GetTrajectoryErrorReport);
	m_serviceGetAllJointsSpeedSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsSpeedSoftLimitation>("base/get_all_joints_speed_soft_limitation", &BaseSimulationServices::GetAllJointsSpeedSoftLimitation);
	m_serviceGetAllJointsTorqueSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetAllJointsTorqueSoftLimitation>("base/get_all_joints_torque_soft_limitation", &BaseSimulationServices::GetAllJointsTorqueSoftLimitation);
	m_serviceGetTwistSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetTwistSoftLimitation>("base/get_twist_soft_limitation", &BaseSimulationServices::GetTwistSoftLimitation);
	m_serviceGetWrenchSoftLimitation = m_node_handle->create_service<kortex_driver::srv::GetWrenchSoftLimitation>("base/get_wrench_soft_limitation", &BaseSimulationServices::GetWrenchSoftLimitation);
	m_serviceSetControllerConfigurationMode = m_node_handle->create_service<kortex_driver::srv::SetControllerConfigurationMode>("base/set_controller_configuration_mode", &BaseSimulationServices::SetControllerConfigurationMode);
	m_serviceGetControllerConfigurationMode = m_node_handle->create_service<kortex_driver::srv::GetControllerConfigurationMode>("base/get_controller_configuration_mode", &BaseSimulationServices::GetControllerConfigurationMode);
	m_serviceStartTeaching = m_node_handle->create_service<kortex_driver::srv::StartTeaching>("base/start_teaching", &BaseSimulationServices::StartTeaching);
	m_serviceStopTeaching = m_node_handle->create_service<kortex_driver::srv::StopTeaching>("base/stop_teaching", &BaseSimulationServices::StopTeaching);
	m_serviceAddSequenceTasks = m_node_handle->create_service<kortex_driver::srv::AddSequenceTasks>("base/add_sequence_tasks", &BaseSimulationServices::AddSequenceTasks);
	m_serviceUpdateSequenceTask = m_node_handle->create_service<kortex_driver::srv::UpdateSequenceTask>("base/update_sequence_task", &BaseSimulationServices::UpdateSequenceTask);
	m_serviceSwapSequenceTasks = m_node_handle->create_service<kortex_driver::srv::SwapSequenceTasks>("base/swap_sequence_tasks", &BaseSimulationServices::SwapSequenceTasks);
	m_serviceReadSequenceTask = m_node_handle->create_service<kortex_driver::srv::ReadSequenceTask>("base/read_sequence_task", &BaseSimulationServices::ReadSequenceTask);
	m_serviceReadAllSequenceTasks = m_node_handle->create_service<kortex_driver::srv::ReadAllSequenceTasks>("base/read_all_sequence_tasks", &BaseSimulationServices::ReadAllSequenceTasks);
	m_serviceDeleteSequenceTask = m_node_handle->create_service<kortex_driver::srv::DeleteSequenceTask>("base/delete_sequence_task", &BaseSimulationServices::DeleteSequenceTask);
	m_serviceDeleteAllSequenceTasks = m_node_handle->create_service<kortex_driver::srv::DeleteAllSequenceTasks>("base/delete_all_sequence_tasks", &BaseSimulationServices::DeleteAllSequenceTasks);
	m_serviceTakeSnapshot = m_node_handle->create_service<kortex_driver::srv::TakeSnapshot>("base/take_snapshot", &BaseSimulationServices::TakeSnapshot);
	m_serviceGetFirmwareBundleVersions = m_node_handle->create_service<kortex_driver::srv::GetFirmwareBundleVersions>("base/get_firmware_bundle_versions", &BaseSimulationServices::GetFirmwareBundleVersions);
	m_serviceExecuteWaypointTrajectory = m_node_handle->create_service<kortex_driver::srv::ExecuteWaypointTrajectory>("base/execute_waypoint_trajectory", &BaseSimulationServices::ExecuteWaypointTrajectory);
	m_serviceMoveSequenceTask = m_node_handle->create_service<kortex_driver::srv::MoveSequenceTask>("base/move_sequence_task", &BaseSimulationServices::MoveSequenceTask);
	m_serviceDuplicateMapping = m_node_handle->create_service<kortex_driver::srv::DuplicateMapping>("base/duplicate_mapping", &BaseSimulationServices::DuplicateMapping);
	m_serviceDuplicateMap = m_node_handle->create_service<kortex_driver::srv::DuplicateMap>("base/duplicate_map", &BaseSimulationServices::DuplicateMap);
	m_serviceSetControllerConfiguration = m_node_handle->create_service<kortex_driver::srv::SetControllerConfiguration>("base/set_controller_configuration", &BaseSimulationServices::SetControllerConfiguration);
	m_serviceGetControllerConfiguration = m_node_handle->create_service<kortex_driver::srv::GetControllerConfiguration>("base/get_controller_configuration", &BaseSimulationServices::GetControllerConfiguration);
	m_serviceGetAllControllerConfigurations = m_node_handle->create_service<kortex_driver::srv::GetAllControllerConfigurations>("base/get_all_controller_configurations", &BaseSimulationServices::GetAllControllerConfigurations);
	m_serviceComputeForwardKinematics = m_node_handle->create_service<kortex_driver::srv::ComputeForwardKinematics>("base/compute_forward_kinematics", &BaseSimulationServices::ComputeForwardKinematics);
	m_serviceComputeInverseKinematics = m_node_handle->create_service<kortex_driver::srv::ComputeInverseKinematics>("base/compute_inverse_kinematics", &BaseSimulationServices::ComputeInverseKinematics);
	m_serviceValidateWaypointList = m_node_handle->create_service<kortex_driver::srv::ValidateWaypointList>("base/validate_waypoint_list", &BaseSimulationServices::ValidateWaypointList);
}
