	...
	IDeviceManagerServices(node_handle)
{
	...
	m_serviceSetDeviceID = m_node_handle->create_service<kortex_driver::srv::SetDeviceID>("device_manager/set_device_id", &DeviceManagerSimulationServices::SetDeviceID, this);
	m_serviceSetApiOptions = m_node_handle->create_service<kortex_driver::srv::SetApiOptions>("device_manager/set_api_options", &DeviceManagerSimulationServices::SetApiOptions, this);

	m_serviceReadAllDevices = m_node_handle->create_service<kortex_driver::srv::ReadAllDevices>("device_manager/read_all_devices", &DeviceManagerSimulationServices::ReadAllDevices, this);
}
