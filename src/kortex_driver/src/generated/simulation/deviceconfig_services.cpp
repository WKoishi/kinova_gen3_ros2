	...
	IDeviceConfigServices(node_handle)
{
	...
	m_serviceSetDeviceID = m_node_handle->create_service<kortex_driver::srv::SetDeviceID>("device_config/set_device_id", &DeviceConfigSimulationServices::SetDeviceID, this);
	m_serviceSetApiOptions = m_node_handle->create_service<kortex_driver::srv::SetApiOptions>("device_config/set_api_options", &DeviceConfigSimulationServices::SetApiOptions, this);

	m_serviceGetRunMode = m_node_handle->create_service<kortex_driver::srv::GetRunMode>("device_config/get_run_mode", &DeviceConfigSimulationServices::GetRunMode, this);
	m_serviceSetRunMode = m_node_handle->create_service<kortex_driver::srv::SetRunMode>("device_config/set_run_mode", &DeviceConfigSimulationServices::SetRunMode, this);
	m_serviceGetDeviceType = m_node_handle->create_service<kortex_driver::srv::GetDeviceType>("device_config/get_device_type", &DeviceConfigSimulationServices::GetDeviceType, this);
	m_serviceGetFirmwareVersion = m_node_handle->create_service<kortex_driver::srv::GetFirmwareVersion>("device_config/get_firmware_version", &DeviceConfigSimulationServices::GetFirmwareVersion, this);
	m_serviceGetBootloaderVersion = m_node_handle->create_service<kortex_driver::srv::GetBootloaderVersion>("device_config/get_bootloader_version", &DeviceConfigSimulationServices::GetBootloaderVersion, this);
	m_serviceGetModelNumber = m_node_handle->create_service<kortex_driver::srv::GetModelNumber>("device_config/get_model_number", &DeviceConfigSimulationServices::GetModelNumber, this);
	m_serviceGetPartNumber = m_node_handle->create_service<kortex_driver::srv::GetPartNumber>("device_config/get_part_number", &DeviceConfigSimulationServices::GetPartNumber, this);
	m_serviceGetSerialNumber = m_node_handle->create_service<kortex_driver::srv::GetSerialNumber>("device_config/get_serial_number", &DeviceConfigSimulationServices::GetSerialNumber, this);
	m_serviceGetMACAddress = m_node_handle->create_service<kortex_driver::srv::GetMACAddress>("device_config/get_m_a_c_address", &DeviceConfigSimulationServices::GetMACAddress, this);
	m_serviceGetIPv4Settings = m_node_handle->create_service<kortex_driver::srv::GetIPv4Settings>("device_config/get_i_pv4_settings", &DeviceConfigSimulationServices::GetIPv4Settings, this);
	m_serviceSetIPv4Settings = m_node_handle->create_service<kortex_driver::srv::SetIPv4Settings>("device_config/set_i_pv4_settings", &DeviceConfigSimulationServices::SetIPv4Settings, this);
	m_serviceGetPartNumberRevision = m_node_handle->create_service<kortex_driver::srv::GetPartNumberRevision>("device_config/get_part_number_revision", &DeviceConfigSimulationServices::GetPartNumberRevision, this);
	m_serviceRebootRequest = m_node_handle->create_service<kortex_driver::srv::RebootRequest>("device_config/reboot_request", &DeviceConfigSimulationServices::RebootRequest, this);
	m_serviceSetSafetyEnable = m_node_handle->create_service<kortex_driver::srv::SetSafetyEnable>("device_config/set_safety_enable", &DeviceConfigSimulationServices::SetSafetyEnable, this);
	m_serviceSetSafetyErrorThreshold = m_node_handle->create_service<kortex_driver::srv::SetSafetyErrorThreshold>("device_config/set_safety_error_threshold", &DeviceConfigSimulationServices::SetSafetyErrorThreshold, this);
	m_serviceSetSafetyWarningThreshold = m_node_handle->create_service<kortex_driver::srv::SetSafetyWarningThreshold>("device_config/set_safety_warning_threshold", &DeviceConfigSimulationServices::SetSafetyWarningThreshold, this);
	m_serviceSetSafetyConfiguration = m_node_handle->create_service<kortex_driver::srv::SetSafetyConfiguration>("device_config/set_safety_configuration", &DeviceConfigSimulationServices::SetSafetyConfiguration, this);
	m_serviceGetSafetyConfiguration = m_node_handle->create_service<kortex_driver::srv::GetSafetyConfiguration>("device_config/get_safety_configuration", &DeviceConfigSimulationServices::GetSafetyConfiguration, this);
	m_serviceGetSafetyInformation = m_node_handle->create_service<kortex_driver::srv::GetSafetyInformation>("device_config/get_safety_information", &DeviceConfigSimulationServices::GetSafetyInformation, this);
	m_serviceGetSafetyEnable = m_node_handle->create_service<kortex_driver::srv::GetSafetyEnable>("device_config/get_safety_enable", &DeviceConfigSimulationServices::GetSafetyEnable, this);
	m_serviceGetSafetyStatus = m_node_handle->create_service<kortex_driver::srv::GetSafetyStatus>("device_config/get_safety_status", &DeviceConfigSimulationServices::GetSafetyStatus, this);
	m_serviceClearAllSafetyStatus = m_node_handle->create_service<kortex_driver::srv::ClearAllSafetyStatus>("device_config/clear_all_safety_status", &DeviceConfigSimulationServices::ClearAllSafetyStatus, this);
	m_serviceClearSafetyStatus = m_node_handle->create_service<kortex_driver::srv::ClearSafetyStatus>("device_config/clear_safety_status", &DeviceConfigSimulationServices::ClearSafetyStatus, this);
	m_serviceGetAllSafetyConfiguration = m_node_handle->create_service<kortex_driver::srv::GetAllSafetyConfiguration>("device_config/get_all_safety_configuration", &DeviceConfigSimulationServices::GetAllSafetyConfiguration, this);
	m_serviceGetAllSafetyInformation = m_node_handle->create_service<kortex_driver::srv::GetAllSafetyInformation>("device_config/get_all_safety_information", &DeviceConfigSimulationServices::GetAllSafetyInformation, this);
	m_serviceResetSafetyDefaults = m_node_handle->create_service<kortex_driver::srv::ResetSafetyDefaults>("device_config/reset_safety_defaults", &DeviceConfigSimulationServices::ResetSafetyDefaults, this);
	m_serviceOnNotificationSafetyTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationSafetyTopic>("device_config/activate_publishing_of_safety_topic", &DeviceConfigSimulationServices::OnNotificationSafetyTopic, this);
	m_serviceExecuteCalibration = m_node_handle->create_service<kortex_driver::srv::ExecuteCalibration>("device_config/execute_calibration", &DeviceConfigSimulationServices::ExecuteCalibration, this);
	m_serviceGetCalibrationResult = m_node_handle->create_service<kortex_driver::srv::GetCalibrationResult>("device_config/get_calibration_result", &DeviceConfigSimulationServices::GetCalibrationResult, this);
	m_serviceStopCalibration = m_node_handle->create_service<kortex_driver::srv::StopCalibration>("device_config/stop_calibration", &DeviceConfigSimulationServices::StopCalibration, this);
	m_serviceDeviceConfig_SetCapSenseConfig = m_node_handle->create_service<kortex_driver::srv::DeviceConfigSetCapSenseConfig>("device_config/set_cap_sense_config", &DeviceConfigSimulationServices::DeviceConfig_SetCapSenseConfig, this);
	m_serviceDeviceConfig_GetCapSenseConfig = m_node_handle->create_service<kortex_driver::srv::DeviceConfigGetCapSenseConfig>("device_config/get_cap_sense_config", &DeviceConfigSimulationServices::DeviceConfig_GetCapSenseConfig, this);
}
