	...
	IControlConfigServices(node_handle)
{
	...
	m_serviceSetDeviceID = m_node_handle->create_service("control_config/set_device_id", &ControlConfigSimulationServices::SetDeviceID, this);
	m_serviceSetApiOptions = m_node_handle->create_service("control_config/set_api_options", &ControlConfigSimulationServices::SetApiOptions, this);

	m_serviceSetGravityVector = m_node_handle->create_service("control_config/set_gravity_vector", &ControlConfigSimulationServices::SetGravityVector, this);
	m_serviceGetGravityVector = m_node_handle->create_service("control_config/get_gravity_vector", &ControlConfigSimulationServices::GetGravityVector, this);
	m_serviceSetPayloadInformation = m_node_handle->create_service("control_config/set_payload_information", &ControlConfigSimulationServices::SetPayloadInformation, this);
	m_serviceGetPayloadInformation = m_node_handle->create_service("control_config/get_payload_information", &ControlConfigSimulationServices::GetPayloadInformation, this);
	m_serviceSetToolConfiguration = m_node_handle->create_service("control_config/set_tool_configuration", &ControlConfigSimulationServices::SetToolConfiguration, this);
	m_serviceGetToolConfiguration = m_node_handle->create_service("control_config/get_tool_configuration", &ControlConfigSimulationServices::GetToolConfiguration, this);
	m_serviceOnNotificationControlConfigurationTopic = m_node_handle->create_service("control_config/activate_publishing_of_control_configuration_topic", &ControlConfigSimulationServices::OnNotificationControlConfigurationTopic, this);
	m_serviceControlConfig_Unsubscribe = m_node_handle->create_service("control_config/unsubscribe", &ControlConfigSimulationServices::ControlConfig_Unsubscribe, this);
	m_serviceSetCartesianReferenceFrame = m_node_handle->create_service("control_config/set_cartesian_reference_frame", &ControlConfigSimulationServices::SetCartesianReferenceFrame, this);
	m_serviceGetCartesianReferenceFrame = m_node_handle->create_service("control_config/get_cartesian_reference_frame", &ControlConfigSimulationServices::GetCartesianReferenceFrame, this);
	m_serviceControlConfig_GetControlMode = m_node_handle->create_service("control_config/get_control_mode", &ControlConfigSimulationServices::ControlConfig_GetControlMode, this);
	m_serviceSetJointSpeedSoftLimits = m_node_handle->create_service("control_config/set_joint_speed_soft_limits", &ControlConfigSimulationServices::SetJointSpeedSoftLimits, this);
	m_serviceSetTwistLinearSoftLimit = m_node_handle->create_service("control_config/set_twist_linear_soft_limit", &ControlConfigSimulationServices::SetTwistLinearSoftLimit, this);
	m_serviceSetTwistAngularSoftLimit = m_node_handle->create_service("control_config/set_twist_angular_soft_limit", &ControlConfigSimulationServices::SetTwistAngularSoftLimit, this);
	m_serviceSetJointAccelerationSoftLimits = m_node_handle->create_service("control_config/set_joint_acceleration_soft_limits", &ControlConfigSimulationServices::SetJointAccelerationSoftLimits, this);
	m_serviceGetKinematicHardLimits = m_node_handle->create_service("control_config/get_kinematic_hard_limits", &ControlConfigSimulationServices::GetKinematicHardLimits, this);
	m_serviceGetKinematicSoftLimits = m_node_handle->create_service("control_config/get_kinematic_soft_limits", &ControlConfigSimulationServices::GetKinematicSoftLimits, this);
	m_serviceGetAllKinematicSoftLimits = m_node_handle->create_service("control_config/get_all_kinematic_soft_limits", &ControlConfigSimulationServices::GetAllKinematicSoftLimits, this);
	m_serviceSetDesiredLinearTwist = m_node_handle->create_service("control_config/set_desired_linear_twist", &ControlConfigSimulationServices::SetDesiredLinearTwist, this);
	m_serviceSetDesiredAngularTwist = m_node_handle->create_service("control_config/set_desired_angular_twist", &ControlConfigSimulationServices::SetDesiredAngularTwist, this);
	m_serviceSetDesiredJointSpeeds = m_node_handle->create_service("control_config/set_desired_joint_speeds", &ControlConfigSimulationServices::SetDesiredJointSpeeds, this);
	m_serviceGetDesiredSpeeds = m_node_handle->create_service("control_config/get_desired_speeds", &ControlConfigSimulationServices::GetDesiredSpeeds, this);
	m_serviceResetGravityVector = m_node_handle->create_service("control_config/reset_gravity_vector", &ControlConfigSimulationServices::ResetGravityVector, this);
	m_serviceResetPayloadInformation = m_node_handle->create_service("control_config/reset_payload_information", &ControlConfigSimulationServices::ResetPayloadInformation, this);
	m_serviceResetToolConfiguration = m_node_handle->create_service("control_config/reset_tool_configuration", &ControlConfigSimulationServices::ResetToolConfiguration, this);
	m_serviceResetJointSpeedSoftLimits = m_node_handle->create_service("control_config/reset_joint_speed_soft_limits", &ControlConfigSimulationServices::ResetJointSpeedSoftLimits, this);
	m_serviceResetTwistLinearSoftLimit = m_node_handle->create_service("control_config/reset_twist_linear_soft_limit", &ControlConfigSimulationServices::ResetTwistLinearSoftLimit, this);
	m_serviceResetTwistAngularSoftLimit = m_node_handle->create_service("control_config/reset_twist_angular_soft_limit", &ControlConfigSimulationServices::ResetTwistAngularSoftLimit, this);
	m_serviceResetJointAccelerationSoftLimits = m_node_handle->create_service("control_config/reset_joint_acceleration_soft_limits", &ControlConfigSimulationServices::ResetJointAccelerationSoftLimits, this);
	m_serviceControlConfig_OnNotificationControlModeTopic = m_node_handle->create_service("control_config/activate_publishing_of_control_mode_topic", &ControlConfigSimulationServices::ControlConfig_OnNotificationControlModeTopic, this);
}
