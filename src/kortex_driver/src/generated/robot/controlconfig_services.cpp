	...
	m_current_device_id(device_id)
{
	...
	m_serviceSetDeviceID = m_node_handle->create_service<kortex_driver::srv::SetDeviceID>("control_config/set_device_id", &ControlConfigRobotServices::SetDeviceID, this);
	m_serviceSetApiOptions = m_node_handle->create_service<kortex_driver::srv::SetApiOptions>("control_config/set_api_options", &ControlConfigRobotServices::SetApiOptions, this);

	m_serviceSetGravityVector = m_node_handle->create_service<kortex_driver::srv::SetGravityVector>("control_config/set_gravity_vector", &ControlConfigRobotServices::SetGravityVector, this);
	m_serviceGetGravityVector = m_node_handle->create_service<kortex_driver::srv::GetGravityVector>("control_config/get_gravity_vector", &ControlConfigRobotServices::GetGravityVector, this);
	m_serviceSetPayloadInformation = m_node_handle->create_service<kortex_driver::srv::SetPayloadInformation>("control_config/set_payload_information", &ControlConfigRobotServices::SetPayloadInformation, this);
	m_serviceGetPayloadInformation = m_node_handle->create_service<kortex_driver::srv::GetPayloadInformation>("control_config/get_payload_information", &ControlConfigRobotServices::GetPayloadInformation, this);
	m_serviceSetToolConfiguration = m_node_handle->create_service<kortex_driver::srv::SetToolConfiguration>("control_config/set_tool_configuration", &ControlConfigRobotServices::SetToolConfiguration, this);
	m_serviceGetToolConfiguration = m_node_handle->create_service<kortex_driver::srv::GetToolConfiguration>("control_config/get_tool_configuration", &ControlConfigRobotServices::GetToolConfiguration, this);
	m_serviceOnNotificationControlConfigurationTopic = m_node_handle->create_service<kortex_driver::srv::OnNotificationControlConfigurationTopic>("control_config/activate_publishing_of_control_configuration_topic", &ControlConfigRobotServices::OnNotificationControlConfigurationTopic, this);
	m_serviceControlConfig_Unsubscribe = m_node_handle->create_service<kortex_driver::srv::ControlConfigUnsubscribe>("control_config/unsubscribe", &ControlConfigRobotServices::ControlConfig_Unsubscribe, this);
	m_serviceSetCartesianReferenceFrame = m_node_handle->create_service<kortex_driver::srv::SetCartesianReferenceFrame>("control_config/set_cartesian_reference_frame", &ControlConfigRobotServices::SetCartesianReferenceFrame, this);
	m_serviceGetCartesianReferenceFrame = m_node_handle->create_service<kortex_driver::srv::GetCartesianReferenceFrame>("control_config/get_cartesian_reference_frame", &ControlConfigRobotServices::GetCartesianReferenceFrame, this);
	m_serviceControlConfig_GetControlMode = m_node_handle->create_service<kortex_driver::srv::ControlConfigGetControlMode>("control_config/get_control_mode", &ControlConfigRobotServices::ControlConfig_GetControlMode, this);
	m_serviceSetJointSpeedSoftLimits = m_node_handle->create_service<kortex_driver::srv::SetJointSpeedSoftLimits>("control_config/set_joint_speed_soft_limits", &ControlConfigRobotServices::SetJointSpeedSoftLimits, this);
	m_serviceSetTwistLinearSoftLimit = m_node_handle->create_service<kortex_driver::srv::SetTwistLinearSoftLimit>("control_config/set_twist_linear_soft_limit", &ControlConfigRobotServices::SetTwistLinearSoftLimit, this);
	m_serviceSetTwistAngularSoftLimit = m_node_handle->create_service<kortex_driver::srv::SetTwistAngularSoftLimit>("control_config/set_twist_angular_soft_limit", &ControlConfigRobotServices::SetTwistAngularSoftLimit, this);
	m_serviceSetJointAccelerationSoftLimits = m_node_handle->create_service<kortex_driver::srv::SetJointAccelerationSoftLimits>("control_config/set_joint_acceleration_soft_limits", &ControlConfigRobotServices::SetJointAccelerationSoftLimits, this);
	m_serviceGetKinematicHardLimits = m_node_handle->create_service<kortex_driver::srv::GetKinematicHardLimits>("control_config/get_kinematic_hard_limits", &ControlConfigRobotServices::GetKinematicHardLimits, this);
	m_serviceGetKinematicSoftLimits = m_node_handle->create_service<kortex_driver::srv::GetKinematicSoftLimits>("control_config/get_kinematic_soft_limits", &ControlConfigRobotServices::GetKinematicSoftLimits, this);
	m_serviceGetAllKinematicSoftLimits = m_node_handle->create_service<kortex_driver::srv::GetAllKinematicSoftLimits>("control_config/get_all_kinematic_soft_limits", &ControlConfigRobotServices::GetAllKinematicSoftLimits, this);
	m_serviceSetDesiredLinearTwist = m_node_handle->create_service<kortex_driver::srv::SetDesiredLinearTwist>("control_config/set_desired_linear_twist", &ControlConfigRobotServices::SetDesiredLinearTwist, this);
	m_serviceSetDesiredAngularTwist = m_node_handle->create_service<kortex_driver::srv::SetDesiredAngularTwist>("control_config/set_desired_angular_twist", &ControlConfigRobotServices::SetDesiredAngularTwist, this);
	m_serviceSetDesiredJointSpeeds = m_node_handle->create_service<kortex_driver::srv::SetDesiredJointSpeeds>("control_config/set_desired_joint_speeds", &ControlConfigRobotServices::SetDesiredJointSpeeds, this);
	m_serviceGetDesiredSpeeds = m_node_handle->create_service<kortex_driver::srv::GetDesiredSpeeds>("control_config/get_desired_speeds", &ControlConfigRobotServices::GetDesiredSpeeds, this);
	m_serviceResetGravityVector = m_node_handle->create_service<kortex_driver::srv::ResetGravityVector>("control_config/reset_gravity_vector", &ControlConfigRobotServices::ResetGravityVector, this);
	m_serviceResetPayloadInformation = m_node_handle->create_service<kortex_driver::srv::ResetPayloadInformation>("control_config/reset_payload_information", &ControlConfigRobotServices::ResetPayloadInformation, this);
	m_serviceResetToolConfiguration = m_node_handle->create_service<kortex_driver::srv::ResetToolConfiguration>("control_config/reset_tool_configuration", &ControlConfigRobotServices::ResetToolConfiguration, this);
	m_serviceResetJointSpeedSoftLimits = m_node_handle->create_service<kortex_driver::srv::ResetJointSpeedSoftLimits>("control_config/reset_joint_speed_soft_limits", &ControlConfigRobotServices::ResetJointSpeedSoftLimits, this);
	m_serviceResetTwistLinearSoftLimit = m_node_handle->create_service<kortex_driver::srv::ResetTwistLinearSoftLimit>("control_config/reset_twist_linear_soft_limit", &ControlConfigRobotServices::ResetTwistLinearSoftLimit, this);
	m_serviceResetTwistAngularSoftLimit = m_node_handle->create_service<kortex_driver::srv::ResetTwistAngularSoftLimit>("control_config/reset_twist_angular_soft_limit", &ControlConfigRobotServices::ResetTwistAngularSoftLimit, this);
	m_serviceResetJointAccelerationSoftLimits = m_node_handle->create_service<kortex_driver::srv::ResetJointAccelerationSoftLimits>("control_config/reset_joint_acceleration_soft_limits", &ControlConfigRobotServices::ResetJointAccelerationSoftLimits, this);
	m_serviceControlConfig_OnNotificationControlModeTopic = m_node_handle->create_service<kortex_driver::srv::ControlConfigOnNotificationControlModeTopic>("control_config/activate_publishing_of_control_mode_topic", &ControlConfigRobotServices::ControlConfig_OnNotificationControlModeTopic, this);
}
