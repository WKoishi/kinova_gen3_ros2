...
class InterconnectConfigSimulationServices : public IInterconnectConfigServices
{
    public:
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetUARTConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::GetUARTConfiguration::Request>)> GetUARTConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetUARTConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::SetUARTConfiguration::Request>)> SetUARTConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetEthernetConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::GetEthernetConfiguration::Request>)> GetEthernetConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetEthernetConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::SetEthernetConfiguration::Request>)> SetEthernetConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetGPIOConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::GetGPIOConfiguration::Request>)> GetGPIOConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetGPIOConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::SetGPIOConfiguration::Request>)> SetGPIOConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetGPIOState::Response>(const std::shared_ptr<kortex_driver::srv::GetGPIOState::Request>)> GetGPIOStateHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetGPIOState::Response>(const std::shared_ptr<kortex_driver::srv::SetGPIOState::Request>)> SetGPIOStateHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetI2CConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::GetI2CConfiguration::Request>)> GetI2CConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetI2CConfiguration::Response>(const std::shared_ptr<kortex_driver::srv::SetI2CConfiguration::Request>)> SetI2CConfigurationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::I2CRead::Response>(const std::shared_ptr<kortex_driver::srv::I2CRead::Request>)> I2CReadHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::I2CReadRegister::Response>(const std::shared_ptr<kortex_driver::srv::I2CReadRegister::Request>)> I2CReadRegisterHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::I2CWrite::Response>(const std::shared_ptr<kortex_driver::srv::I2CWrite::Request>)> I2CWriteHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::I2CWriteRegister::Response>(const std::shared_ptr<kortex_driver::srv::I2CWriteRegister::Request>)> I2CWriteRegisterHandler = nullptr;
