...
class VisionConfigSimulationServices : public IVisionConfigServices
{
    public:
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetSensorSettings::Response>(const std::shared_ptr<kortex_driver::srv::SetSensorSettings::Request>)> SetSensorSettingsHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetSensorSettings::Response>(const std::shared_ptr<kortex_driver::srv::GetSensorSettings::Request>)> GetSensorSettingsHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetOptionValue::Response>(const std::shared_ptr<kortex_driver::srv::GetOptionValue::Request>)> GetOptionValueHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetOptionValue::Response>(const std::shared_ptr<kortex_driver::srv::SetOptionValue::Request>)> SetOptionValueHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetOptionInformation::Response>(const std::shared_ptr<kortex_driver::srv::GetOptionInformation::Request>)> GetOptionInformationHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::OnNotificationVisionTopic::Response>(const std::shared_ptr<kortex_driver::srv::OnNotificationVisionTopic::Request>)> OnNotificationVisionTopicHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::DoSensorFocusAction::Response>(const std::shared_ptr<kortex_driver::srv::DoSensorFocusAction::Request>)> DoSensorFocusActionHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetIntrinsicParameters::Response>(const std::shared_ptr<kortex_driver::srv::GetIntrinsicParameters::Request>)> GetIntrinsicParametersHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetIntrinsicParametersProfile::Response>(const std::shared_ptr<kortex_driver::srv::GetIntrinsicParametersProfile::Request>)> GetIntrinsicParametersProfileHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetIntrinsicParameters::Response>(const std::shared_ptr<kortex_driver::srv::SetIntrinsicParameters::Request>)> SetIntrinsicParametersHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetExtrinsicParameters::Response>(const std::shared_ptr<kortex_driver::srv::GetExtrinsicParameters::Request>)> GetExtrinsicParametersHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetExtrinsicParameters::Response>(const std::shared_ptr<kortex_driver::srv::SetExtrinsicParameters::Request>)> SetExtrinsicParametersHandler = nullptr;
