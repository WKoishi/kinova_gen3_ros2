...
class ActuatorConfigSimulationServices : public IActuatorConfigServices
{
    public:
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetAxisOffsets::Response>(const std::shared_ptr<kortex_driver::srv::GetAxisOffsets::Request>)> GetAxisOffsetsHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetAxisOffsets::Response>(const std::shared_ptr<kortex_driver::srv::SetAxisOffsets::Request>)> SetAxisOffsetsHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetTorqueOffset::Response>(const std::shared_ptr<kortex_driver::srv::SetTorqueOffset::Request>)> SetTorqueOffsetHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::ActuatorConfigGetControlMode::Response>(const std::shared_ptr<kortex_driver::srv::ActuatorConfigGetControlMode::Request>)> ActuatorConfig_GetControlModeHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetControlMode::Response>(const std::shared_ptr<kortex_driver::srv::SetControlMode::Request>)> SetControlModeHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetActivatedControlLoop::Response>(const std::shared_ptr<kortex_driver::srv::GetActivatedControlLoop::Request>)> GetActivatedControlLoopHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetActivatedControlLoop::Response>(const std::shared_ptr<kortex_driver::srv::SetActivatedControlLoop::Request>)> SetActivatedControlLoopHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetControlLoopParameters::Response>(const std::shared_ptr<kortex_driver::srv::GetControlLoopParameters::Request>)> GetControlLoopParametersHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetControlLoopParameters::Response>(const std::shared_ptr<kortex_driver::srv::SetControlLoopParameters::Request>)> SetControlLoopParametersHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SelectCustomData::Response>(const std::shared_ptr<kortex_driver::srv::SelectCustomData::Request>)> SelectCustomDataHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetSelectedCustomData::Response>(const std::shared_ptr<kortex_driver::srv::GetSelectedCustomData::Request>)> GetSelectedCustomDataHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetCommandMode::Response>(const std::shared_ptr<kortex_driver::srv::SetCommandMode::Request>)> SetCommandModeHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::ActuatorConfigClearFaults::Response>(const std::shared_ptr<kortex_driver::srv::ActuatorConfigClearFaults::Request>)> ActuatorConfig_ClearFaultsHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetServoing::Response>(const std::shared_ptr<kortex_driver::srv::SetServoing::Request>)> SetServoingHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::MoveToPosition::Response>(const std::shared_ptr<kortex_driver::srv::MoveToPosition::Request>)> MoveToPositionHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetCommandMode::Response>(const std::shared_ptr<kortex_driver::srv::GetCommandMode::Request>)> GetCommandModeHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetServoing::Response>(const std::shared_ptr<kortex_driver::srv::GetServoing::Request>)> GetServoingHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetTorqueOffset::Response>(const std::shared_ptr<kortex_driver::srv::GetTorqueOffset::Request>)> GetTorqueOffsetHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::SetCoggingFeedforwardMode::Response>(const std::shared_ptr<kortex_driver::srv::SetCoggingFeedforwardMode::Request>)> SetCoggingFeedforwardModeHandler = nullptr;
        ...
        std::function<std::shared_ptr<kortex_driver::srv::GetCoggingFeedforwardMode::Response>(const std::shared_ptr<kortex_driver::srv::GetCoggingFeedforwardMode::Request>)> GetCoggingFeedforwardModeHandler = nullptr;
